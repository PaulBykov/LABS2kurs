...
void TSPUtil(int map[V][V])
{
	...
	cout << "\nÐàçìåð ïîïóëÿöèè: " << endl << "Äëèíà ïóòè ãåíîìà:\n";
	for (int i = 0; i < POP_SIZE; i++)
	{
	...
	{
		cout << endl << "Ñàìûé ëó÷øèé ãåíîì: " << population[0].genome << endl;
		cout << endl << "Ñàìûé ëó÷øèé ïóòü: " << population[0].way << endl;

		cout << "\nÒåêóùàÿ òåìïåðàòóðà: " << temperature << "\n";
