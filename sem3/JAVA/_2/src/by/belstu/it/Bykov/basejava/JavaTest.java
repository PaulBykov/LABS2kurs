...
public class JavaTest {
    ...
    public static void main(String[] args) {
        ...
        byte byte_var = 127;
        long long_var = 1000000000000000000L;
        boolean bool = true;

        System.out.println("Результат string + int: " + string_var + int_var);
        System.out.println("Результат string + char: " + string_var + symbol_var);
        System.out.println("Результат string + double: " + string_var + double_var);

        byte b_var2; int i_var2; long l_var2;

        b_var2 = (byte) (byte_var + int_var);
        System.out.println("Результат byte = byte + int: " + b_var2);

        i_var2 = (int) (double_var + long_var);
        System.out.println("Результат int = double + long: " + i_var2);

        l_var2 = (long) (int_var + 2147483647);
