...
export class Validator{
    ...
    private _validateController: React.Dispatch<SetStateAction<boolean[][]>>;

    public constructor(field: Field, out: boolean[][], controller: React.Dispatch<SetStateAction<boolean[][]>>) {
        this._field = field;
        this._validity = [...out];
