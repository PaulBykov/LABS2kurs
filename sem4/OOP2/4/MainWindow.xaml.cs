...
namespace _4
{
    public partial class MainWindow : Window
    {
        ...
        {
            NewProduct newProduct = new NewProduct(_controller);
            newProduct.Show();
        }
        ...
        private void Button_Click_2(object sender, RoutedEventArgs e)
        {
            ...
            invoker.SetCommand(new ChangeProduct(new Receiver(_db.Db)));
            invoker.Run(sneaker);
        ...
        private void Button_Click_3(object sender, RoutedEventArgs e)
        {
            ...
            Invoker invoker = new Invoker();
            invoker.SetCommand(new RemoveProduct(new Receiver(_db.Db)));
            invoker.Run(sneaker);
